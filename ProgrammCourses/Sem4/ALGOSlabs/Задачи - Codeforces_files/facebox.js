...
$.extend($.facebox,{settings:{opacity:0.2,overlay:true,loadingImage:'/static/images/facebox/loading.gif',closeImage:'/static/images/facebox/closelabel.png',imageTypes:['png','jpg','jpeg','gif'],faceboxHtml:'\
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        <div class="content"> \
        </div> \
        <a href="#" class="close"><img src="/static/images/facebox/closelabel.png" title="close" class="close_image" /></a> \
      </div> \
